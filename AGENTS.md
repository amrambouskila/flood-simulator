...
Applies global `AGENTS.md` section 19 to this repo. Security is part of the Definition of Done for every task and part of the CI pipeline from the first pipeline commit onward.
